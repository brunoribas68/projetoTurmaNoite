...
<a style="margin-left:100px" href="{{route('formularioMateria')}}" class="sm:justify-center">
                ...
                @if($materias)
                    @foreach($materias as $materia)
                        <tr>
                            ...
                            <td>{{ $materia['area_de_estudo'] }}</td>
                            <td>
                                <a href="{{route('deletarMateria').'?id='.$materia["id"]}}">
                            ...
                            <td>
                                <a href="{{route('formularioEditarMateria').'?id='.$materia["id"]}}">
